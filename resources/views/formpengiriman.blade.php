...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">Stok Peternak PT. Anugerah Kartika Agro Blitar</h3>
    </div>
    <!-- /.card-header -->
      ...
      <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
        ...
        <thead>
            <tr>
                ...
                <th>Nama Barang</th>
                <th>Jumlah Stok</th>
                <th>Input Jumlah Pengiriman (karung)</th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($dataPakan as $item)
                <tr>
                    ...
                    <td>{{ $item->stok }}</td>
                    <td>
                        <input type="number" id="stokp" name="stokp">
                    </td>
                    <input type="hidden" id="idpeternak" name="idpeternak" value="{{$item->id}}">
                    <input type="hidden" id="idbarang" name="idbarang" value="{{$item->idbarang}}">
                    <td>
